...
c.NotebookApp.config_file = u'/usr/local/airflow/.jupyter/jupyter_notebook_config.py'
...
#  
#  Hased version of default password -> notebook
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$AoCe4VvEQ5PPVj7tgGvcAA$Rw5v6rDEA1sE4j3w0X+iNA'
...
#  Choices: any of ['sha3_256', 'sha224', 'sha3_384', 'md5', 'sha3_512', 'sha384', 'blake2b', 'blake2s', 'sha3_224', 'sha1', 'sha256', 'sha512']
#  Default: 'sha256'
